            ...
            <div class="card-body">
                <form action="{{ route('order.update', $order->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="custom-select form-control @error('order_status') is-invalid @enderror"
                                id="orderStatus" name="order_status">
                                <option>Select Status</option>
                                @foreach (Config::get('constants.DELIVERY_STATUS') as $key => $value)
                                    )
                                    <option value="{{ $key }}" @if (old('order_status') == $key || $key == $order->order_status) selected @endif>
                                        {{ $value }}</option>
                                @endforeach
                            </select>
                            @error('order_status')
                    ...
                    <div class="form-group row d-none deliveryDate">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control date @error('delivery_date') is-invalid @enderror"
                                name="delivery_date" value="{{ $order->delivery_date ?? '' }}" id="datetimepicker">
                            @error('delivery_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row d-none returnedDate">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control date @error('returned_date') is-invalid @enderror"
                                name="returned_date" value="{{ $order->returned_date ?? '' }}" id="datetimepicker">
                            @error('returned_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row d-none redeliveryDate">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control date @error('redelivery_date') is-invalid @enderror"
                                name="redelivery_date" value="{{ $order->redelivery_date ?? '' }}" id="datetimepicker">
                    ...
                    <div class="form-group row d-none cancelDate">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control date @error('cancelation_date') is-invalid @enderror"
                                name="cancelation_date" value="{{ $order->cancelation_date ?? '' }}" id="datetimepicker">
                            @error('redelivery_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
